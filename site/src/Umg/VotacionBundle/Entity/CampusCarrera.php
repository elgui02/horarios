...
class CampusCarrera
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Semestre", mappedBy="campusCarrera")
     * @ORM\JoinColumn(name="id", referencedColumnName="CampusCarrera_id")
     */
    protected $semestres;
    ...
    /**
     * Add Semestre entity to collection (one to many).
     *
    ...
    /**
     * Remove Semestre entity from collection (one to many).
     *
     * @param \Umg\VotacionBundle\Entity\Semestre $semestre
     * @return \Umg\VotacionBundle\Entity\CampusCarrera
     */
    public function removeSemestre(Semestre $semestre)
    {
    ...
    /**
     * Get Semestre entity collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
